...
export default function Footer() {
    return (
        <footer className='w-[110%] md:w-full bg-gradient-to-br from-[#c874d9] to-[#5937e5] text-white'>
            <div className='block md:flex gap-5 justify-around items-center  md:px-5 py-10 w-full' >
                <div className='py-2 flex gap-3 md:gap-5 justify-around items-center'>
                    ...
                    <p className="text-xl font-black">
                        ...
                        <a href="tel:+919408122456" className="text-lg font-semibold hover:underline">
                        Contact : 94081 22456
                        </a>
                    </p>
                </div>
